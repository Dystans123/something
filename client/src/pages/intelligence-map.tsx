        ...
        <div className="container mx-auto max-w-4xl">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="text-center">
              ...
              <Badge variant="outline" className="text-blue-400 border-blue-400 text-xs md:text-sm">
            ...
            <Card className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border-blue-400/30 relative overflow-hidden">
              ...
              <CardHeader className="text-center relative z-10 pb-6 md:pb-8 p-4 md:p-6">
                <motion.div
                  ...
                  className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6"
                >
                  <Brain className="h-8 w-8 md:h-10 md:w-10 text-blue-400" />
                </motion.div>
