      ...
      <div className="relative z-10 container mx-auto px-6 py-12 max-w-4xl">
            ...
            <Card className="bg-gradient-to-br from-pink-500/10 to-rose-500/10 border-pink-400/30 relative overflow-hidden">
              ...
              <CardHeader className="text-center relative z-10 pb-8">
                <motion.div
                  ...
                  className="w-20 h-20 bg-gradient-to-br from-pink-500/20 to-rose-500/20 rounded-full flex items-center justify-center mx-auto mb-6"
                >
        ...
        >
          ...
          <Button
            ...
            disabled={!canAttachmentStyleProceed(state.answers, state.currentQuestionIndex)}
            className="px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 text-white border-0"
          >
            {state.currentQuestionIndex === attachmentStyleQuestions.length - 1 ? 'Complete' : 'Next'}
